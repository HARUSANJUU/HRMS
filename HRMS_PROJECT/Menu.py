...
def check_in():
    os.system("python check_in.py")
    window.withdraw()
menu_btn1 = tk.Button(btm_frame, image=main_btn,command=check_in, borderwidth=0)
menu_btn1.grid(row=0, column=0, padx=10, pady=10)
label1 = ttk.Label(btm_frame, text="Check-In", font='Arial 10 bold')
label1.grid(row=1, column=0)

def check_out():
    os.system("python check_out.py")
    window.withdraw()
menu_btn2 = tk.Button(btm_frame, image=main_btn,command=check_out, borderwidth=0)
...
def rooms():
    ...
    window.withdraw()
menu_btn4 = tk.Button(btm_frame, image=main_btn,command=rooms, borderwidth=0)
...
def archive():
    os.system("python Archive v2.py")
    window.withdraw()
menu_btn5 = tk.Button(btm_frame, image=main_btn,command=archive,borderwidth=0)
...
slide_frame.pack(side="top", fill="y")
